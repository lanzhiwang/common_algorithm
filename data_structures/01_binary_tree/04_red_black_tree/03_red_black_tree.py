...
r"""
#############################################################
remove(self=root, label)
    remove(self=root.left, label)
    remove(self=root.right, label)
    O -> self
     \
      O
       \
...
#############################################################
remove(self=root.left, label)
    remove(self=root.left.left, label)
    remove(self=root.left.right, label)

remove(self=root.right, label)
    remove(self=root.right.left, label)
    remove(self=root.right.right, label)
    O
     \
      O -> self
       \
...
#############################################################
remove(self=root.left.left, label)
    remove(self=root.left.left.left, label)
    remove(self=root.left.left.right, label)

remove(self=root.left.right, label)
    remove(self=root.left.right.left, label)
    remove(self=root.left.right.right, label)

remove(self=root.right.left, label)
    remove(self=root.right.left.left, label)
    remove(self=root.right.left.right, label)

remove(self=root.right.right, label)
    remove(self=root.right.right.left, label)
    remove(self=root.right.right.right, label)
    O
     \
      O
       \
